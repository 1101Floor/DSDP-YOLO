...
class CBAM(nn.Module):
    def __init__(self, c1, c2=None, ratio=16, kernel_size=7, *args, **kwargs):
...
import torch
import torch.nn as nn
from ultralytics.nn.modules.block import C2f_HDSB
...
def yaml_model_load(path):
    ...
    unified_path = re.sub(r"(\d+)([nslmx])(.+)?$", r"\1\3", str(path))  # i.e. yolov8x.yaml -> yolov8m-HDSB.yaml
